...
class App extends Component {
  ...
  renderNoCountriesView = () => (
    <div className="noView-container">
      <p className="noView-paragraph">
        No Countries Visited Yet" should be displayed
      </p>
    </div>
  )
  ...
  render() {
    ...
    return (
      <div className="appContainer">
        ...
        <ul className="coutryList-container">
        ...
        {updateList.length === 0 ? (
          this.renderNoCountriesView()
        ) : (
          <ul className="visitedCountrylist-container">
            {updateList.map(eachDetails => (
              <VisitedCountries
                key={eachDetails.id}
                visitedCountryList={eachDetails}
